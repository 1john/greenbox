function ageVerify() {
	...
	function checkCookie() {
		...
		if (age === "over21") {
			...
			$('body').prepend("<div class=\"age-check\"><div class=\"text-wrapper\"><p>Are you over 21?</p><button class=\"confirm button btn btn-primary btn-age-check\">Yes</button><button class=\"cancel button btn btn-primary btn-age-check\">No</button></div></div>");

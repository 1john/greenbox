(function() {
  ...
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.getXhr = function() {
      return xhr;
    };
    ...
    S3Upload.prototype.executeOnSignedUrl = function(file, callback) {
      ...
      xhr.onreadystatechange = function(e) {
        ...
        if (this.readyState === 4 && this.status === 200) {
          ...
          var s = result.signed_request;//here we removed decodeURIComponent because it was causing 403 forbidden errors from s3 when a '+' character was in the signature
          return callback(s, result.url);
